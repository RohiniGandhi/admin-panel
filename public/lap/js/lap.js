...
function addremoveTextbox() {
    ...
    $("#addButton").click(function (){
        ...
        var newTextBoxDiv = $(document.createElement("div"))
            .attr("id", "TextBoxDiv" + counter).attr("class", "col-sm-5");

        newTextBoxDiv.after().html('<label class=".form-group">'+'</label>' + 
            '<input class="form-control textbox" type="text" name="breadcrumb' + counter + 
            '" id="breadcrumb' + '" value="" >');
